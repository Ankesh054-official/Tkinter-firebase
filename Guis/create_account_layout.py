...
def create_ac(self,title1):
    ...
    for i in endis:
        ...
        l = Label(self, text="{0}".format(endis[indec]), bg="black", fg="Grey",
    ...
    bt = Button(self, activebackground="black", activeforeground="white", text="{0}".format(dic[0]), bg="white", fg="black", font=("comicsansms", 12, "bold"),
                    relief=SUNKEN, borderwidth=3, command=enter).place(x=550,y=600)
    bt = Button(self, activebackground="black", activeforeground="white", text="{0}".format(dic[1]), bg="black", fg="blue", font=("comicsansms", 7, "bold"),
                    relief=FLAT, borderwidth=-1, command=lambda self=self: signin_layout.signin(self,title1="{0}".format(dic[1]))).place(x=800, y=650)
    bt = Button(self, activebackground="black", activeforeground="white", text="{0}".format(dic[2]), bg="white", fg="black", font=("comicsansms", 9, "bold"),
    ...
    bt = Button(self, activebackground="black", activeforeground="white", text="{0}".format(dic[3]), bg="black", fg="blue", font=("comicsansms", 12, "bold"),relief=FLAT,
                    borderwidth=-1, command=lambda: main.terms_and_conditions()).place(x=80, y=600)
    self.mainloop()